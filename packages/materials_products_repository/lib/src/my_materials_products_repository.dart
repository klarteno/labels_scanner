import 'package:materials_products_api/my_api.dart';
...
class MyMaterialsProductsRepository {
  MyMaterialsProductsRepository({ProductsApi? shopifyApi})
      : _shopifyApi = shopifyApi ?? ProductsApi();

  final ProductsApi _shopifyApi;
