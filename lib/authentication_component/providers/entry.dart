...
import 'package:labels_scanner/authentication_component/data/entry.dart';
...
class EntryProvider extends ChangeNotifier {
  ...
  Future<Uint8List> imageFor(Entry entry) async {
    ...
    final result = await ApiClient.storage
        .getFileView(fileId: entry.thumbnailImageId, bucketId: 'my_bucket_1');
