...
import '../../../app_component/nested_navigation/app_navigator.dart';
...
class TagsPage1 extends RScreen<AppNavigator, BarCodesSegment> {
  const TagsPage1(BarCodesSegment segment, this.screenTitle) : super(segment);
